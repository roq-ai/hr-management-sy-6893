...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'hr-manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Payrolls', path: '/payrolls', entity: 'payroll', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
    {
    ...
    { name: 'Vacations', path: '/vacations', entity: 'vacation', service: AccessServiceEnum.PROJECT, icon: FiSun },
