          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Bonus" text={data?.bonus} />

                <FormListItem label="Deduction" text={data?.deduction} />

                <FormListItem
                  label="Pay Date"
                  text={data?.pay_date ? format(parseISO(data?.pay_date as unknown as string), 'dd-MM-yyyy') : ''}
                />
