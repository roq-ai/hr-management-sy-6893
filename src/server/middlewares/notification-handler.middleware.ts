...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'HR Manager.create': { roles: ['owner'], key: 'onboarding', tenantPath: [], userPath: [] },
  'HR Manager.delete': { roles: ['owner'], key: 'offboarding', tenantPath: [], userPath: [] },
  'Owner.update': { roles: ['owner', 'hr-manager'], key: 'policy', tenantPath: [], userPath: [] },
};
